...
\begin{enumerate}
    ...
    \item On peut se demander à partir de quand il n'existe pas de solution "parfaite", c'est à dire une configuration où chaque longueur de 1 à \(\ell\) est mesurable d'une seule manière.
\end{enumerate}


\vspace{1\baselineskip}

Le problème consiste donc à déterminer le nombre $m(\ell)$ minimal de graduations nécessaires pour mesurer toute longueur entière de 1 à $\ell$ avec une règle de longueur $\ell$.