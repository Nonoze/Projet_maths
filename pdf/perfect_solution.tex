\subsubsection*{(v) Déterminer à partir de quel \( \ell \) qu'il n'existe pas de solution parfaite. Une solution parfaite est une configuration de graduations telle que chaque longueur de 1 à \( \ell \) soit mesurable d'une seule manière.}
