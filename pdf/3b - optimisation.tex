...
Même avec l'aide de toutes ces approximations, il est difficile de prouver rigoureusement une quelconque conjecture. Nous savons donc que \( f(x) \) est en \( \Theta(\sqrt{x}) \), mais nous ne pouvons pas affirmer davantage.