...
Nous avons donc démontrer que la plus grande valeur de \( \ell \) pour laquelle une solution parfaite existe est \( n = 4 \) (et \( \ell = 6 \)).

\medskip

Les solutions parfaites sont donc les suivantes:

\begin{itemize}
    \item Pour \( n = 2 \) (i.e. \( \ell = 1 \)): \\
    Graduations en \( \{0, 1\} \)
    
    \item Pour \( n = 3 \) (i.e. \( \ell = 3 \)): \\
    Graduations en \( \{0, 1, 3\} \)
    
    \item Pour \( n = 4 \) (i.e. \( \ell = 6 \)): \\
    Graduations en \( \{0, 1, 4, 6\} \) ou \( \{0, 2, 5, 6\} \)
\end{itemize}