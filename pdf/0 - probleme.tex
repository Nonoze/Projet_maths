...
\begin{enumerate}
    ...
    \item On peut se demander s'il existe des solutions "parfaites", c'est à dire des configurations où chaque longueur de 1 à \(\ell\) est mesurable d'une seule manière.
